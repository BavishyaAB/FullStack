...
describe("favorite blog", () => {
  ...
  test("of empty list is null", () => {
    const blogs = []
    assert.deepEqual(listHelper.favoriteBlog(blogs), null)
  })
  test("when list has only 1 blog equals that blog", () => {
    const blogs = listWithOneBlog
    assert.deepEqual(listHelper.favoriteBlog(blogs), blogs[0])
  })
  test("of a bigger list is calculated right", () => {
    const blogs = listWithManyBlogs
...
describe("most liked author", () => {
  ...
  test("of a bigger list is calculated right", () => {
    ...
    assert.deepEqual(listHelper.mostLikes(blogs), result)
  })
})
describe("most blogged author", () => {
  ...
  test("of a bigger list is calculated right", () => {
    ...
    assert.deepEqual(listHelper.mostBlogs(blogs), result)
  })
})